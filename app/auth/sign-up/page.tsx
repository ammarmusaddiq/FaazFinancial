      ...
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Start Your Business Journey</CardTitle>
            <CardDescription>Create your FaazFinancialGroup account to begin forming your company</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="terms" className="text-sm leading-relaxed">
                    I agree to the{" "}
                    <Link href="/legal/terms" className="text-cyan-600 hover:text-cyan-700 underline">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link href="/legal/privacy" className="text-cyan-600 hover:text-cyan-700 underline">
                      Privacy Policy
                    </Link>
                  </Label>
                </div>
